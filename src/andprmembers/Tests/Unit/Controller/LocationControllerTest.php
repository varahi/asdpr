...
{
    /**
     * @var \T3Dev\Andprmembers\Controller\LocationController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\T3Dev\Andprmembers\Controller\LocationController::class)
    ...
    public function listActionFetchesAllLocationsFromRepositoryAndAssignsThemToView()
    {
        ...
        $locationRepository = $this->getMockBuilder(\T3Dev\Andprmembers\Domain\Repository\LocationRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $location = new \T3Dev\Andprmembers\Domain\Model\Location();
